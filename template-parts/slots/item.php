<div class="relative">
  <img src="<?php echo carbon_get_the_post_meta('crb_slot_logo'); ?>"  alt="<?php echo carbon_get_the_post_meta("crb_slots_name"); ?>" loading="lazy" class="w-full h-full aspect-square rounded-lg mb-4">
